...
import net.zhiyuan51.dev.android.selectimage.ImageApdater;
...
import net.zhiyuan51.dev.android.selectimage.view.MediaItemLayout;
...
public class ChoiceImageActivity extends AppCompatActivity {
    ...
    static int mMaxCount = 9;//图片选择数量限制
    ...
    class LoadImage extends AsyncTask<Void, Integer, Boolean> {
        ...
        protected Boolean doInBackground(Void... voids) {
            if (imageHelper.getThumbnail(ChoiceImageActivity.this)) {
