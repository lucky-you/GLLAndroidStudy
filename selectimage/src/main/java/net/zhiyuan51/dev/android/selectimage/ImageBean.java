package net.zhiyuan51.dev.android.selectimage;
...
public class ImageBean implements Parcelable {
    ...
    public ImageBean(String image_name, double image_size, String image_path, String image_desc, String image_thumbnails, boolean isSelect) {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeDouble(this.image_size);
