...
public class GridImageView extends AppCompatImageView {
    ...
    public GridImageView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.GridImageView, defStyleAttr, 0);
        type = a.getInt(R.styleable.GridImageView_type, TYPE_OVAL);
        mBorderColor = a.getColor(R.styleable.GridImageView_border_color, Color.WHITE);
        mBorderWidth = a.getDimension(R.styleable.GridImageView_border_width, 0);
        mCornerRadius = a.getDimension(R.styleable.GridImageView_corner_radius, dp2px(6));
        mLeftTopCornerRadius = a.getDimension(R.styleable.GridImageView_leftTop_corner_radius, 0);
        mLeftBottomCornerRadius = a.getDimension(R.styleable.GridImageView_leftBottom_corner_radius, 0);
        mRightTopCornerRadius = a.getDimension(R.styleable.GridImageView_rightTop_corner_radius, 0);
        mRightBottomCornerRadius = a.getDimension(R.styleable.GridImageView_rightBottom_corner_radius, 0);
        a.recycle();
        init();
    }
     ...
     * 默认为圆形图片
     */
    public GridImageView setType(int imageType) {
     ...
     * 设置圆角图片的圆角大小
     */
    public GridImageView setCornerRadius(int cornerRadius) {
     ...
     * 设置圆角图片的左上圆角大小
     */
    public GridImageView setLeftTopCornerRadius(int cornerRadius) {
        cornerRadius = dp2px(cornerRadius);
     ...
     * 设置圆角图片的右上圆角大小
     */
    public GridImageView setRightTopCornerRadius(int cornerRadius) {
        cornerRadius = dp2px(cornerRadius);
     ...
     * 设置圆角图片的左下圆角大小
     */
    public GridImageView setLeftBottomCornerRadius(int cornerRadius) {
        cornerRadius = dp2px(cornerRadius);
     ...
     * 设置圆角图片的右下圆角大小
     */
    public GridImageView setRightBottomCornerRadius(int cornerRadius) {
        cornerRadius = dp2px(cornerRadius);
     ...
     * 设置描边宽度
     */
    public GridImageView setBorderWidth(int borderWidth) {
     ...
     * 设置描边颜色
     */
    public GridImageView setBorderColor(int borderColor) {
