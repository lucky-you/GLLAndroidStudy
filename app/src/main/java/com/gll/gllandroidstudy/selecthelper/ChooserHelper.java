//package com.gll.gllandroidstudy.selecthelper;
//
...
//        void onSelectListener(AreaEntity provinceid, AreaEntity.ChildBeanX cityid, AreaEntity.ChildBeanX.ChildBean area);
//    }
//
//    /**
//     * 显示日期的选择器
...
//                } else {
//                    address = wheelPicker.getProvince() + " " + wheelPicker.getCity() + " " + (wheelPicker.getArea() == null ? "" : wheelPicker.getArea());
//                }
...
//                    onselectListener.onSelectListener((AreaEntity) wheelPicker.getProvince(), (AreaEntity.ChildBeanX) wheelPicker.getCity(), (AreaEntity.ChildBeanX.ChildBean) wheelPicker.getArea());
//                }
//                dialog.dismiss();
//            }
//        });
