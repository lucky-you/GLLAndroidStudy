...
public class CustomTitleView extends View {
    ...
    public CustomTitleView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        for (int i = 0; i < n; i++) {
            ...
            switch (attr) {
                case R.styleable.CustomTitleView_cusTextViewText:
                    mTitleText = typedArray.getString(attr);
                    break;
                case R.styleable.CustomTitleView_cusTextViewColor:
                    // 默认颜色设置为黑色
                    mTitleTextColor = typedArray.getColor(attr, Color.BLACK);
                    break;
                case R.styleable.CustomTitleView_cusTextViewSize:
