...
//    private SmoothScrollLinearLayoutManager layoutManager;
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            a = context.obtainStyledAttributes(attrs, R.styleable.MarqueeView);
            mScrollItemCount = a.getInteger(R.styleable.MarqueeView_scrollItemCount, 1);
            mShowItemCount = a.getInteger(R.styleable.MarqueeView_showItemCount, 1);
            mStandDuration = a.getInteger(R.styleable.MarqueeView_standDuration, MILLISECONDS_MARQUEE_STAND);
