...
import com.gll.gllandroidstudy.anim.ChartAnimator;
...
public class PieChartView extends View {
    ...
    private void initRadius(Context context) {
        ...
        // 计算半径（扇形）
        pieRadius = screenW / 5;
        mBottomRadius = pieRadius + SizeUtils.dp2px(5);
    ...
    private void initData(Context context) {
        ...
        textPaint.setTextSize(SizeUtils.dp2px(13f));
    ...
    private void drawText(Canvas canvas) {
        ...
        midPaint.setTextSize(SizeUtils.dp2px(13f));
