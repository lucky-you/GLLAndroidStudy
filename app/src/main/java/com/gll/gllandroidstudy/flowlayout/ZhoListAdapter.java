 ...
 * function  :集合列表适配器
 */
public abstract class ZhoListAdapter<T> extends BaseAdapter {
    private List<T> mData = new ArrayList<>();
    private OnListItemListener<T> mOnListItemListener;
    private Context mContext;

    public ZhoListAdapter(Context context) {
        mContext = context;
    }

    public ZhoListAdapter(Context context, OnListItemListener<T> callback) {
        this(context);
        mOnListItemListener = callback;
    }

    public ZhoListAdapter(Context context, List<T> data) {
        mContext = context;
        setData(data);
    }

    public ZhoListAdapter(Context context, T[] data) {
        mContext = context;
        setData(data);
    }
